...
async function tiktokDl(url) {
	return new Promise(async (resolve, reject) => {
		try {
			...
			// [AUDIT-FIX] Sebelumnya catch kosong -> Promise tak pernah settle -> command
			// .tiktok/.ttsearch menggantung selamanya (promise+socket leak). Settle dengan
			// status:false agar pemanggil (yang cek result.status) menampilkan error.
